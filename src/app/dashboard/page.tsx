...
if (params.get('payment') === 'success') {
   alert('✅ Plan PRO activado correctamente')
}
const NAV = [
  ...
  { href: '/pricing', label: 'Plan y pagos', section: 'Cuenta', icon: <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg> },
]
