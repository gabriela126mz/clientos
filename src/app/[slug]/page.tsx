  ...
  return (
    <>
      <style>{`
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;overflow-x:hidden;background:#ffffff;font-family:Inter,system-ui,sans-serif;color:var(--ink)}a{text-decoration:none;color:inherit}img{max-width:100%;display:block}button{font:inherit}
        .loader{min-height:100vh;display:grid;place-items:center;text-align:center;background:linear-gradient(135deg,#ffffff,#f8fafc);color:var(--ink);font-size:1.1rem}.loader div{font-size:4rem;margin-bottom:1rem}
        ...
        .section{padding:clamp(70px,10vw,126px) clamp(20px,5vw,72px);position:relative;background:linear-gradient(180deg,#ffffff 0%,#fbfdff 100%)}.wrap{width:min(1180px,100%);margin:auto}.section.alt{background:radial-gradient(circle at 8% 18%,rgba(15,23,42,.045),transparent 34%),radial-gradient(circle at 92% 8%,rgba(148,163,184,.16),transparent 30%),linear-gradient(180deg,#f7f9fc 0%,#ffffff 100%)}.section.dark{background:linear-gradient(135deg,var(--ink),color-mix(in srgb,var(--p) 72%,#101522));color:white}.section.photo-band{background:radial-gradient(circle at 18% 20%,color-mix(in srgb,var(--a) 22%,transparent),transparent 32%),linear-gradient(135deg,color-mix(in srgb,var(--p) 90%,#111827),#0f172a 58%,color-mix(in srgb,var(--s) 55%,#111827));color:white}.photo-band .wrap{background:linear-gradient(135deg,rgba(255,255,255,.16),rgba(255,255,255,.07));border:1px solid rgba(255,255,255,.2);border-radius:38px;padding:clamp(42px,6vw,78px);backdrop-filter:blur(14px);box-shadow:0 30px 90px rgba(0,0,0,.28)}.photo-band .h2{font-size:clamp(3rem,6.8vw,6.2rem);text-shadow:0 10px 34px rgba(0,0,0,.34)}.photo-band .sub{color:rgba(255,255,255,.9);font-size:clamp(1.08rem,2vw,1.3rem)}.head{text-align:center;margin:0 auto 46px;max-width:930px}.tag{display:flex;align-items:center;justify-content:center;gap:12px;color:var(--s);font-weight:900;font-size:.78rem;letter-spacing:.22em;text-transform:uppercase;margin-bottom:18px}.tag:before,.tag:after{content:'';width:36px;height:2px;background:currentColor}.h2{font-size:clamp(2.5rem,6.5vw,5.5rem)}.sub{font-size:clamp(1rem,1.8vw,1.18rem);line-height:1.8;color:#5b6478;max-width:760px;margin:22px auto 0}.dark .sub{color:rgba(255,255,255,.78)}
        .trust{background:radial-gradient(circle at 12% 10%,rgba(15,23,42,.06),transparent 30%),radial-gradient(circle at 88% 88%,rgba(148,163,184,.22),transparent 36%),linear-gradient(135deg,#f6f8fb 0%,#ffffff 52%,#eef2f7 100%);padding-block:74px;position:relative;overflow:hidden}.trust:before{content:'';position:absolute;left:7%;right:7%;top:0;height:1px;background:linear-gradient(90deg,transparent,rgba(15,23,42,.14),transparent)}.trust-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.trust-card{background:#ffffff;border:1px solid rgba(15,23,42,.09);border-radius:30px;padding:34px 26px;text-align:center;box-shadow:0 22px 70px rgba(15,23,42,.075);min-height:178px;display:flex;flex-direction:column;justify-content:center;position:relative;overflow:hidden;transition:transform .35s ease,box-shadow .35s ease,border-color .35s ease}.trust-card:before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(255,255,255,.95),rgba(248,250,252,.85));opacity:.9;pointer-events:none}.trust-card>*{position:relative}.trust-card:hover{transform:translateY(-8px);box-shadow:0 30px 75px rgba(15,23,42,.12);border-color:color-mix(in srgb,var(--a) 60%,#fff)}.trust-card b{display:block;font-size:clamp(2rem,4.4vw,3.5rem);font-family:'Playfair Display';color:var(--p);line-height:1}.trust-card span{display:block;margin-top:10px;color:#5b6478;font-weight:800;line-height:1.45}
        .about{display:grid;grid-template-columns:.85fr 1fr;gap:46px;align-items:center}.photo-stack{position:relative;min-height:580px}.photo-main{position:absolute;inset:0 14% 8% 0;border-radius:34px;overflow:hidden;box-shadow:0 30px 90px rgba(0,0,0,.18)}.photo-main img,.photo-small img{width:100%;height:100%;object-fit:cover}.photo-small{position:absolute;right:0;bottom:0;width:44%;height:260px;border:10px solid #fff;border-radius:30px;overflow:hidden;box-shadow:0 24px 70px rgba(0,0,0,.16)}.logo-badge{position:absolute;left:28px;top:28px;background:rgba(255,255,255,.92);backdrop-filter:blur(14px);border-radius:24px;padding:14px 18px;display:flex;align-items:center;gap:12px;font-weight:900;box-shadow:0 20px 60px rgba(0,0,0,.16)}.logo-badge img{width:46px;height:46px;border-radius:14px;object-fit:cover}.about-text p{font-size:1.1rem;line-height:1.9;color:#4f5870;margin:0 0 18px}.address-box{margin-top:22px;padding:18px 20px;border:1px solid rgba(0,0,0,.08);border-radius:22px;background:#fff;display:flex;gap:14px;align-items:flex-start;box-shadow:0 18px 50px rgba(0,0,0,.06)}.address-box strong{display:block;color:var(--p);margin-bottom:4px}
        .benefit-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:26px;margin-top:42px}.benefit{position:relative;overflow:hidden;min-height:240px;background:#fff;border:1px solid rgba(0,0,0,.08);border-radius:34px;padding:34px;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;box-shadow:0 20px 60px rgba(0,0,0,.06);transition:transform .35s ease,box-shadow .35s ease,border-color .35s ease}.benefit:before{content:'';position:absolute;inset:-1px;background:linear-gradient(135deg,rgba(248,250,252,.92),rgba(255,255,255,.65));opacity:.9;pointer-events:none}.benefit:after{content:'✦';position:absolute;right:24px;top:18px;color:var(--s);font-size:1.8rem;opacity:.35;animation:softFloat 3.4s ease-in-out infinite}.benefit>*{position:relative}.benefit:hover{transform:translateY(-12px) scale(1.025);box-shadow:0 34px 90px rgba(0,0,0,.14);border-color:color-mix(in srgb,var(--a) 70%,#fff)}.benefit h3{font-size:1.28rem;color:var(--p);margin:0 0 14px}.benefit p{font-size:1.05rem;color:#566075;line-height:1.75;margin:0;max-width:280px}
        .services{display:grid;grid-template-columns:repeat(3,1fr);gap:24px}.service{position:relative;overflow:hidden;border-radius:34px;background:white;box-shadow:0 24px 80px rgba(0,0,0,.08);border:1px solid rgba(0,0,0,.08);min-height:460px;display:flex;flex-direction:column}.service-img{height:210px;overflow:hidden}.service-img img{width:100%;height:100%;object-fit:cover;transition:.45s}.service:hover .service-img img{transform:scale(1.08)}.service-body{padding:32px;text-align:center;display:flex;flex-direction:column;align-items:center;flex:1}.service-icon{width:70px;height:70px;margin-top:-68px;margin-bottom:18px;border-radius:22px;display:grid;place-items:center;background:#f8fafc;border:8px solid white;font-size:2rem;box-shadow:0 18px 40px rgba(0,0,0,.08)}.service h3{margin:0 0 12px;font-size:1.38rem;color:var(--p);letter-spacing:-.04em}.service p{margin:0;color:#5b6478;line-height:1.75}.service a{margin-top:auto;color:var(--s);font-weight:900;padding-top:22px}
        .marquee{display:none}
        .process-layout{display:block}.process-photo{display:none}.process-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:22px}.step{position:relative;overflow:hidden;border-radius:32px;padding:34px 26px;background:#fff;border:1px solid rgba(0,0,0,.08);box-shadow:0 18px 55px rgba(0,0,0,.06);min-height:250px;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;transition:transform .35s ease,box-shadow .35s ease}.step:before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(248,250,252,.98),rgba(255,255,255,.74));transition:.35s}.step:after{content:'';position:absolute;left:22%;right:22%;bottom:18px;height:3px;border-radius:999px;background:linear-gradient(90deg,transparent,var(--s),transparent);opacity:.18;transition:.35s}.step:hover{transform:translateY(-12px);box-shadow:0 34px 90px rgba(0,0,0,.14)}.step:hover:before{transform:scale(1.03)}.step:hover:after{opacity:.45;left:14%;right:14%}.step-num{position:relative;width:64px;height:64px;border-radius:20px;background:linear-gradient(135deg,var(--a),color-mix(in srgb,var(--a) 68%,#fff));color:var(--p);display:grid;place-items:center;font-weight:900;margin:0 auto 24px;box-shadow:0 16px 36px rgba(15,23,42,.14);animation:softFloat 4s ease-in-out infinite}.step h3{position:relative;font-size:1.28rem;margin:0 0 12px;color:var(--p)}.step p{position:relative;margin:0;line-height:1.75;color:#566075}
        ...
        .faq{max-width:960px;margin:auto;display:grid;gap:18px}.faq-item{opacity:1!important;transform:none!important;background:white;border-radius:26px;border:1px solid rgba(0,0,0,.08);box-shadow:0 16px 50px rgba(0,0,0,.06);overflow:hidden;transition:box-shadow .3s,transform .3s,border-color .3s}.faq-item:hover{transform:translateY(-4px)!important;box-shadow:0 28px 75px rgba(0,0,0,.1);border-color:color-mix(in srgb,var(--a) 65%,#fff)}.faq-q{width:100%;display:flex;align-items:center;justify-content:space-between;gap:16px;text-align:left;padding:25px 28px;background:white;color:var(--ink);border:0;cursor:pointer;font-weight:900;font-size:1.12rem}.faq-plus{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:#f8fafc;color:var(--s);font-weight:900;font-size:1.65rem;flex:none;transition:.25s}.faq-item.open .faq-plus{transform:rotate(45deg);background:var(--a);color:var(--p)}.faq-a{max-height:0;overflow:hidden;border-top:0 solid rgba(0,0,0,.06);background:#ffffff;transition:max-height .35s ease,border-top-width .25s}.faq-item.open .faq-a{max-height:260px;border-top-width:1px}.faq-a-inner{padding:0}.faq-a p{margin:0;padding:22px 28px 30px;color:#5b6478;line-height:1.75;font-size:1.03rem}
        .contact{display:grid;grid-template-columns:.9fr 1.1fr;gap:36px;align-items:stretch}.contact-card,.form-card{border-radius:34px;padding:34px;background:#fff;box-shadow:0 24px 80px rgba(0,0,0,.08);border:1px solid rgba(0,0,0,.08)}.contact-card{background:linear-gradient(135deg,var(--p),var(--ink));color:white}.contact-card h2{font:700 clamp(2.4rem,5vw,4.4rem)/.98 'Playfair Display';letter-spacing:-.05em;margin:0 0 20px}.info{display:grid;gap:14px;margin:28px 0}.info a,.info div{display:flex;gap:12px;align-items:flex-start;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.14);border-radius:18px;padding:16px;color:white}.socials{display:flex;gap:12px;flex-wrap:wrap}.socials a{display:inline-flex;align-items:center;gap:9px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.16);padding:12px 15px;border-radius:999px;color:white;font-weight:900}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.field.full{grid-column:1/-1}.field label{display:block;margin-bottom:7px;color:var(--p);font-size:.78rem;text-transform:uppercase;letter-spacing:.1em;font-weight:900}.field input,.field textarea{width:100%;border:1px solid rgba(0,0,0,.1);background:#ffffff;border-radius:16px;padding:15px;font:inherit;outline:none}.field textarea{min-height:130px;resize:vertical}.field input:focus,.field textarea:focus{border-color:var(--s);box-shadow:0 0 0 5px color-mix(in srgb,var(--s) 12%,transparent)}.submit{width:100%;margin-top:16px;border:0;border-radius:999px;padding:17px;background:var(--p);color:white;font-weight:900;text-transform:uppercase;letter-spacing:.1em}.sent{text-align:center;padding:54px 16px}.sent b{font-family:'Playfair Display';font-size:2rem;display:block;margin:12px 0;color:var(--p)}
